...
export const ToolCallSchema = z
  ...
  .describe("Tool call (function or custom)");
...
const ContentPartInputAudioSchema = z
  ...
  .describe("Audio input content part");
...
const DeveloperMessageParamSchema = z
  ...
  .describe("Developer message param");
...
const AssistantMessageParamSchema = z
  ...
  .describe("Assistant message param");
...
const FunctionMessageParamSchema = z
  ...
  .describe("Function message param");
...
export const MessageParamSchema = z
  ...
  .describe("DeepSeek message param (OpenAI-compatible)");
